...
namespace Spcm{
      ...
      private:
          ...
          uint64_t buff_sz_nele{1 * 1024ll * 1024ll/2}; //4 factor of 4 1 channel output latency of 6.71 ms. Software buffer size
          uint64_t hw_buff_sz_nele{1 * 1024ll * 1024ll/2}; //2 1 channel output latency of 1.67 ms. Hardware buffer size number of elements
