...
//     std::vector<float> amps = {amp0+0.005,amp0-0.022,amp0-0.008,amp0+0.002,amp0+0.025};
         std::vector<float> amps = {amp0+0.005,amp0-0.025,amp0-0.008,amp0-0.001,amp0+0.025};
...
//    std::vector<double> freqs2 = {107e6,124e6};
//    std::vector<float> phases2 = {0.74086594,0.81601378};
//    std::vector<float> amps2 = {amp0};
//    std::vector<double> freqs2 = {129.0e6};
//    std::vector<float> phases2 = {0.81601378};

    std::vector<float> amps2 = {amp0-0.00,amp0+0.01,amp0-0.0042,amp0+0.01,amp0+0.024};
    std::vector<double> freqs2 = {107.5968e6,118.1976e6,128.7984e6,139.3992e6,150e6};
     //std::vector<double> freqs2 = {107e6,118e6,129e6,140e6,151e6};
    // std::vector<double> freqs2 = {107e6,118e6,129e6,140e6,151e6};
