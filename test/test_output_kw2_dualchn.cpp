...
int main()
{
    ...
    */
    ...
    std::vector<float> amps2 = {amp0+0.03,amp0-0.005,amp0+0.005,amp0+0.01,amp0+0.005,amp0-0.01,amp0+0.005,amp0+0.01,amp0+0.005,amp0+0.01};
...
//    std::vector<double> freqs2 = {102.4680e6,107.8486e6,113.2292e6,118.6098e6,123.9904e6,129.3710e6,134.7516e6,140.1322e6,145.5128e6,150.8934e6};
    std::vector<double> freqs2 = {102.4680e6,107.7684e6,113.0688e6,118.3692e6,123.6696e6,128.9700e6,134.2704e6,139.5708e6,144.8712e6,150.e6};    
