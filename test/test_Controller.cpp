...
int main() {
    ...
    double phase_to_phase_cnt, amp_scale, t_scale;
    phase_to_phase_cnt = 625e7f;
    amp_scale = 6.7465185e9f;
    t_scale = 625e6f/32;
    ...
    cmd_vector.push_back(::Spcm::Cmd::getAmpSet(10 * t_scale, 2, 0.1f * amp_scale));
